...
public class Tienda extends JFrame implements ActionListener {
	...
	// manejador de eventos, hace click y llama a los métodos de la clase principal, comprueba que los botones o los items de menu (tabs) fue clickeado y llama al metodo correspondiente.
